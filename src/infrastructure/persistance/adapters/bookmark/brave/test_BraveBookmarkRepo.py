...
class TestBraveBookmarkRepo:
	def test_get_full_toolbar(self):
		...
		expected_bookmarks_folder = Folder(name="root", children=[
			Folder(name="whitelisted root level Folder", children=[ 
				Folder(name="1. level whitelisted Folder", children=[
					Bookmark(name="2. Level whitelisted Bookmark", url= "https://whitelist.com"),
					Bookmark(name="2. Level blacklisted Bookmark", url= "https://blacklist.com"),
				]),	
				Bookmark(name="1. Level whitelisted Bookmark", url= "https://whitelist.com"),
				Bookmark(name="1. Level blacklisted Bookmark", url= "https://blacklist.com")
				]),
			Bookmark(name="root level whitelisted bookmark", url= "https://whitelist.com"),
			Bookmark(name="root level blacklisted bookmark", url= "https://blacklist.com"),
		])
	...
	def test_get_whitelisted_toolbar(self):
		...
		assert whitelisted_toolbar == Folder(name="root", children=[
			Folder(name="whitelisted root level Folder", children=[ 
				Folder(name="1. level whitelisted Folder", children=[
					Bookmark(name="2. Level whitelisted Bookmark", url= "https://whitelist.com"),
				]),	
